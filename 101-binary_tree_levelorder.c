...
/**
 * levels_rec - Calls func on all nodes for each level.
 * @head: Pointer to head of linked list with nodes at each level.
 * @func: Pointer to a function to call for each node.
 */
void levels_rec(ll *head, void (*func)(int))
{
...
/**
 * get_children - appends children of parent to a linkedlist.
